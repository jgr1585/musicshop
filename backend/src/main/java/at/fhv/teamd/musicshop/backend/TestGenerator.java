...
public class TestGenerator {
    ...
    private static void generateTestData() {
        ...
        mediums1.add(new Medium(BigDecimal.valueOf(12), MediumType.CD, Stock.of(Quantity.of(25)), new Supplier("ZYX Music GmbH & Co KG - CD", Duration.ofDays(3))));
        mediums1.add(new Medium(BigDecimal.valueOf(22), MediumType.VINYL, Stock.of(Quantity.of(5)), new Supplier("ZYX Music GmbH & Co KG - VINYL", Duration.ofDays(4))));
        ...
        mediums4.add(new Medium(BigDecimal.valueOf(13), MediumType.CD, Stock.of(Quantity.of(7)), new Supplier("ZYX Music GmbH & Co KG", Duration.ofDays(6))));
        ...
        mediums5.add(new Medium(BigDecimal.valueOf(19), MediumType.CD, Stock.of(Quantity.of(17)), new Supplier("ZYX Music GmbH & Co KG", Duration.ofDays(1))));
        ...
        Song songLetItBe = new Song("Two of Us", labelLetItBe, releaseLetItBe, genreLetItBe, "", mbidLetItBe, mediums5, Duration.ofMinutes(3), Set.of(artistLetItBe));
        ...
        mediums6.add(new Medium(BigDecimal.valueOf(19), MediumType.CD, Stock.of(Quantity.of(17)), new Supplier("ZYX Music GmbH & Co KG", Duration.ofDays(1))));
        ...
        Song songEverything = new Song("Juanita / Kiteless", labelEverything, releaseEverything, genreEverything, "", mbidEverything, mediums6, Duration.ofMinutes(12), Set.of(artistEverything));
        ...
        mediums7.add(new Medium(BigDecimal.valueOf(19), MediumType.CD, Stock.of(Quantity.of(17)), new Supplier("ZYX Music GmbH & Co KG", Duration.ofDays(1))));
        ...
        Song songTouchBlue = new Song("So What?", labelTouchBlue, releaseTouchBlue, genreTouchBlue, "", mbidTouchBlue, mediums7, Duration.ofMinutes(9), Set.of(artistTouchBlue));
