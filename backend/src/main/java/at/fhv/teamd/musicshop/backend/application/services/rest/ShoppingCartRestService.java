...
public class ShoppingCartRestService {
    ...
    public Response getShoppingCart() {
        ...
        return Response.ok(ServiceFactory.getShoppingCartServiceInstance().getShoppingCart(authenticatedUser)).build();
    }
    ...
    public Response buyFromShoppingCart(BuyFromShoppingCartForm form) {
        ...
        String invoiceNo;
        try {
            invoiceNo = ServiceFactory.getShoppingCartServiceInstance().buyFromShoppingCart(authenticatedUser, form.customerId);
        } catch (IllegalArgumentException e) {
